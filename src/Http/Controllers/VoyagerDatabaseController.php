...
class VoyagerDatabaseController extends Controller
{
    ...
    public function storeBread(Request $request)
    {
        ...
        try {
            ...
            $data = $res
                ? $this->alertSuccess(__('voyager::voyager.database.success_created_bread'))
                : $this->alertError(__('voyager::voyager.database.error_creating_bread'));
            if ($res) {
    ...
    public function updateBread(Request $request, $id)
    {
        ...
        try {
            ...
            $res = $dataType->updateDataType($request->all(), true);
            $data = $res
                ? $this->alertSuccess(__('voyager::voyager.database.success_update_bread', ['datatype' => $dataType->name]))
                : $this->alertError(__('voyager::voyager.database.error_updating_bread'));
            if ($res) {
    ...
    public function deleteBread($id)
    {
        ...
        $data = $res
            ? $this->alertSuccess(__('voyager::voyager.database.success_remove_bread', ['datatype' => $dataType->name]))
            : $this->alertError(__('voyager::voyager.database.error_updating_bread'));
        if ($res) {
